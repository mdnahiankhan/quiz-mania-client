            ...
            <div className="w-1/3 mx-auto p-8 space-y-3 rounded-xl dark:bg-gray-200 dark:text-gray-900">
                ...
                <form onSubmit={handleSubmit(handleSignIn)} novalidate="" action="" className="space-y-6">
                    <div className="space-y-1 text-sm">
                        <label for="email" className="block dark:text-gray-900">Username</label>
                        <input type="email" name="email" {...register('email')} required id="email" placeholder="Email" className="w-full px-4 py-3 rounded-md dark:border-gray-900 dark:bg-white dark:text-gray-900 focus:dark:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
                        <label for="password" className="block dark:text-gray-900">Password</label>
                        <input type="password" name="password" {...register('password')} required id="password" placeholder="Password" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-white dark:text-gray-900 focus:dark:border-violet-400" />
